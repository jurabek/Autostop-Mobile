...
{
    class WorkLocationEditorViewModelTests : BaseAutoMockedReactiveTest<WorkLocationEditorViewModel>
    {
        [Test, AutoDomainData]
        ...
        public void SelectedSearchResult_SetsHomeAddress_WhenSelectedResultIsAutoCompleteResultModel(IEnumerable<AutoCompleteResultModel> autoCompleteResultModels, Address address)
        {
            ...
            GetMock<ISettingsProvider>().Verify(x => x.SetWorkAddress(address), Times.Once());
