...
namespace Google.Maps.Places
{
    ...
    /// </summary>
    [Obsolete(
        "Radar search is deprecated as of June 30, 2018. After that time, this feature will no longer be available.")]
    public class RadarSearchRequest : PlacesRequest
    {
        ...
        public override Uri ToUri()
        {
            ...
            if (!string.IsNullOrEmpty(Keyword))
                qsb.Append("keyword", Keyword.ToLowerInvariant());
            ...
            if (!string.IsNullOrEmpty(Name))
                qsb.Append("name", Name.ToLowerInvariant());
