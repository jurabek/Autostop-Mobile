...
namespace Google.Maps
{
    ...
    public class MapMarkers
    {
        ...
        /// <summary>
        ///     Gets or sets the size of marker from the set {tiny, mid, small}. If no size parameter is set, the marker will
        ///     appear in its default (normal) size. (optional)
        /// </summary>
        public MarkerSizes MarkerSize { get; set; }


        /// <summary>
        ///     Gets or sets the label for the markers.  This specifies a single uppercase alphanumeric character from the set
        ///     {A-Z, 0-9}. (The requirement for uppercase characters is new to the 3.7 version of the API.)
        ///     Note that default and mid sized markers are the only markers capable of displaying an alphanumeric-character
        ///     parameter. tiny and small markers are not capable of displaying an alphanumeric-character.
        ///     (optional)
        /// </summary>
        ...
        ///     services have the advantage of automatically encoding URLs. Icons are limited to sizes of 4096 pixels (64x64 for
        ///     square images),
        ///     and the Static Maps service allows up to five unique custom icons per request. Note that each of these unique icons
        ///     may be used multiple times within the static map. Custom icons that have a shadow:true descriptor (the default)
        ///     will have
        ///     their "anchor point" set as the bottom center of the provided icon image, from which the shadow is cast. Icons
        ///     without
        ...
        /// <summary>
        ///     Gets or sets the flag for building a shadow.  When true (the default value), this indicates that the Static Maps
        ///     service should construct an appropriate
        ...
        /// <summary>
        ///     Affects the number of pixels marker can use. Markers are limited to sizes of 4096 pixels (64x64 for square images)
        ///     by default.
        ...
        ///     See
        ///     http://stackoverflow.com/questions/10336646/how-can-i-use-high-resolution-custom-markers-with-the-scale-parameter-in-google
        /// </summary>
