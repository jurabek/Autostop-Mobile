...
namespace Google.Maps
{
    public class PolylineEncoder
    {
        ...
        {
            var oneEFive = Convert.ToDouble(1e5);
            ...
            foreach (var coordinate in coordinates)
            {
                ...
                var lnge5 = (int) (coordinate.Longitude * oneEFive);
        ...
        public static IEnumerable<LatLng> Decode(string value)
        {
            ...
            var polylinechars = value.ToCharArray();
            var index = 0;
            ...
            while (index < polylinechars.Length)
            {
                ...
                var point = new LatLng(
                    Convert.ToDouble(currentLat) / 100000.0,
        ...
        {
            var sgn_num = num << 1; //shift the binary value
