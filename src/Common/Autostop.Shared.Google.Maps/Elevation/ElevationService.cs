...
{
    /// <summary>
    ///     The Elevation service provides elevation data for all locations on the surface of the earth, including depth
    ///     locations on the ocean floor (which return negative values).
    ///     In those cases where Google does not possess exact elevation measurements at the precise location you request, the
    ///     service will interpolate and return an averaged value
