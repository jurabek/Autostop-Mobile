...
namespace Google.Maps.Roads
{
    ...
    public class SnappedPoint
    {
        ...
        ///     However, if you've set interpolate=true, then it's possible that the response will contain more coordinates than
        ///     the request.
        ///     Interpolated values will not have an originalIndex. These values are indexed from 0,
        ///     so a point with an originalIndex of 4 will be the snapped value of the 5th latitude/longitude passed to the path
        ///     parameter.
        /// </summary>
        ...
        ///     you can pass the placeId to the Google Places API or the Google Maps Geocoding API. Within the Google Maps Roads
        ///     API,
