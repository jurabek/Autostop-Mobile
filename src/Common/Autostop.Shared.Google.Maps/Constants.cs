...
namespace Google.Maps
{
    internal static class Constants
    {
        ...
        public const string expectedColors = "black, brown, green, purple, yellow, blue, gray, orange, red, white"
            ; //pasted straight from the website.

        private static readonly string[] S_ExpectedNamedColors;

        private static readonly int[] S_ExpectedScaleValues;

        static Constants()
        {
            S_ExpectedNamedColors =
                expectedColors.Replace(", ", ",")
                    .Split(','); //since we paste straight from the website, we remove spaces, and convert to an array.
            S_ExpectedScaleValues = new[] {1, 2, 4};
        }
        ...
        {
            if (Contains(S_ExpectedScaleValues, value)) return true;
        ...
        {
            const string HEADING_PARAMETER_RANGE =
                "Heading value must be greater or equal to 0 and less than or equal to 360";
        ...
        {
            const string PITCH_PARAMETER_RANGE =
                "Pitch value must be greater or equal to -90 and less than or equal to 90.";
